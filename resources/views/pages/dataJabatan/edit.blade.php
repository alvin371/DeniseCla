        ...
        <form action="/jabatan/{{$jabatan->id}}" method="post" enctype="multipart/form-data">
            ...
            <div class="flex mx-4 my-2">
                <div class="flex col mx-5">
                    <label for="gaji" class="my-2 w-48">Ubah Jabatan </label>
                    <input type="text" autocomplete="off" class="form-control block w-full px-4 py-2 text-md font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="exampleFormControlInput2" placeholder="Buat Jabatan Baru" name='jabatan' id="jabatan" value="{{$jabatan->jabatan}}" />
                </div>
